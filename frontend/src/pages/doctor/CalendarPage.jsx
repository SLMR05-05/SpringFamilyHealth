...
  // ⭐️ STATE MỚI: Quản lý Modal Tạo Lịch Hẹn ⭐️
...
        statusText: "Chờ khám"
      });
      message.success("Cuộc hẹn đã được khôi phục.");
  };
...
      {/* CALENDAR NAVIGATION & CREATE APPOINTMENT BUTTON */}
...
           {/* ⭐️ NÚT TẠO LỊCH HẸN MỚI ⭐️ */}
           <Button 
                type="primary" 
                icon={<PlusOutlined />}
                className="bg-indigo-600 hover:bg-indigo-700 font-semibold w-1/2 lg:w-auto"
...
           <Button 
                type="default" 
                className="font-semibold w-1/2 lg:w-auto"
...
    />
    
    {/* ⭐️ GỌI COMPONENT MODAL TẠO LỊCH HẸN MỚI ⭐️ */}
