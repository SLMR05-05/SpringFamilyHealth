      ...
      <div className="w-full flex flex-col justify-center px-8 sm:px-12 lg:px-20 py-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className={`space-y-5 overflow-hidden transition-all duration-500 ease-in-out ${role === 'user' ? 'max-h-[100px] opacity-100' : 'max-h-0 opacity-0'}`}>
              {role === 'user' && (
                <div className="group animate-fadeIn">
                  <label className="block text-sm font-semibold text-slate-700 mb-1.5 ml-1">
                    {t('RegisterPage.FamilyCode')} <span className="text-red-400">*</span>
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400 group-focus-within:text-teal-500 transition-colors">
                    ...
                    <input
                      ...
                      placeholder="VD: FAM-123"
                    />
                  </div>
                  <p className="text-xs text-slate-500 mt-1 ml-1">{t('RegisterPage.FamilyCodeHint')}</p>
                </div>
              )}
            </div>
